    ...
    fn parse() {
        ...
        Config {
            ...
            animations: Animations {
                ...
                layer_bar_close: LayerCloseAnim {
                    anim: Animation {
                        off: false,
                        kind: Easing(
                            EasingParams {
                ...
                layer_wallpaper_open: LayerOpenAnim {
                    anim: Animation {
                        off: false,
                        kind: Easing(
                            EasingParams {
                ...
                layer_wallpaper_close: LayerCloseAnim {
                    anim: Animation {
                        off: false,
                        kind: Easing(
                            EasingParams {
                ...
                layer_launcher_open: LayerOpenAnim {
                    anim: Animation {
                        off: false,
                        kind: Easing(
                            EasingParams {
                ...
                layer_launcher_close: LayerCloseAnim {
                    anim: Animation {
                        off: false,
                        kind: Easing(
                            EasingParams {

...
use super::{compute_overview_zoom, ActivateWindow, HitType, LayoutElement, Options, ZoomProgress};
...
pub struct Monitor<W: LayoutElement> {
    ...
    /// In-progress zoom animation or gesture for this monitor.
    pub(super) zoom_progress: Option<ZoomProgress>,
}

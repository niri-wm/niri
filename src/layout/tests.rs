...
impl Op {
    fn apply(self, layout: &mut Layout<TestWindow>) {
        match self {
            ...
            Op::FocusWindowOrWorkspaceOrMonitorDown => layout.focus_window_or_workspace_or_monitor_down(),
            Op::FocusWindowOrWorkspaceOrMonitorUp => layout.focus_window_or_workspace_or_monitor_up(),

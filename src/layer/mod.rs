...
impl ResolvedLayerRules {
    ...
    /// Effective close animation: rule override, else the global default.
    pub fn effective_layer_close(&self, animations: &Animations) -> LayerCloseAnim {
        self.layer_close
            .clone()
            .unwrap_or_else(|| animations.layer_close.clone())
    }
